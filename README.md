...
[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/GenZmeY/KF2-DroppedPickupLifespan)](CHANGELOG.md)
[![GitHub](https://img.shields.io/github/license/GenZmeY/KF2-DroppedPickupLifespan)](COPYING)

## Description
Mutator that changes the lifespan of dropped weapons and dosh.  
...
To save your server's ranked status use [ranked patch](https://github.com/GenZmeY/KF2-Ranked-Patch).  
...
`git clone --recurse-submodules https://github.com/GenZmeY/KF2-DroppedPickupLifespan`  
4. Go to the source folder:  
`cd KF2-DroppedPickupLifespan`
5. Compile:  
`./tools/builder -c`  
...
- https://codeberg.org/GenZmeY/KF2-DroppedPickupLifespan  
